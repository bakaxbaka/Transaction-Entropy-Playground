...
Converting TxID (64 hex characters) to BigInt
Modulo operation against secp256k1 curve order to ensure valid key
Deriving multiple address formats from single private key
